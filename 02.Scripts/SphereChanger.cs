...
public class SphereChanger : MonoBehaviour {
    ...
    {
        //Change the Scenes
        Application.LoadLevel("360_image_mapping");
    }
    ...
    IEnumerator FadeScene(Transform nextSphere)
    {
    ...
    //    Start the fading process
    //    StartCoroutine(FadeScene(nextScene));

    //}

    public void ChangeSphere2(Transform nextSphere)
    {
    ...
    public void ChangeSphere3(Transform nextSphere)
    {
    ...
    public void ChangeSphere4(Transform nextSphere)
    {
    ...
    public void ChangeSphere5(Transform nextSphere)
    {
